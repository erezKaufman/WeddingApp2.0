...
//        if (view == null) {
        ...
        view = inflater.inflate(postpc.project.erez0_000.weddingapp.R.layout.expanded_list_group, null);
        groupViewHolder = new GroupViewHolder();
        groupViewHolder.tvGroup = view.findViewById(postpc.project.erez0_000.weddingapp.R.id.tv_group);
        groupViewHolder.cbGroup = view.findViewById(postpc.project.erez0_000.weddingapp.R.id.cb_group);
        groupViewHolder.groupConstrainLayout = view.findViewById(postpc.project.erez0_000.weddingapp.R.id.groupConstrainLayout);
...
//        });
        ...
        groupViewHolder.imbGroup = view.findViewById(postpc.project.erez0_000.weddingapp.R.id.imageButton);
...
//        final EditTaskItem editTaskItem;
        ...
        view = inflater.inflate(postpc.project.erez0_000.weddingapp.R.layout.expanded_list_item, null);
        childViewHolder = new ChildViewHolder();
        childViewHolder.tvChild = view.findViewById(postpc.project.erez0_000.weddingapp.R.id.tv_child);
        childViewHolder.listItemLinearLayout = view.findViewById(postpc.project.erez0_000.weddingapp.R.id.listItemLinearLayout);
        childViewHolder.cbChild = view.findViewById(postpc.project.erez0_000.weddingapp.R.id.cb_child);
