package postpc.project.erez0_000.weddingapp.parseJSON.adapters;
...
import postpc.project.erez0_000.weddingapp.activities.BusinessesActivity;
...
//        view = inflater.inflate(R.layout.display_list_business_raw,parent,false) ;
        view = LayoutInflater.from(mContext).inflate(postpc.project.erez0_000.weddingapp.R.layout.display_list_business_raw,parent,false);
        ...
        viewHolder.itemView.setBackgroundResource(postpc.project.erez0_000.weddingapp.R.color.transp);
        return viewHolder;
    }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            view_container = itemView.findViewById(postpc.project.erez0_000.weddingapp.R.id.container);
            tv_name = itemView.findViewById(postpc.project.erez0_000.weddingapp.R.id.anime_name);
            tv_type = itemView.findViewById(postpc.project.erez0_000.weddingapp.R.id.type);
            tv_address = itemView.findViewById(postpc.project.erez0_000.weddingapp.R.id.address);
            tv_region = itemView.findViewById(postpc.project.erez0_000.weddingapp.R.id.region);
