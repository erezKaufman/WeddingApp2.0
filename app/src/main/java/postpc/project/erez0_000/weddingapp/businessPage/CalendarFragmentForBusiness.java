...
public class CalendarFragmentForBusiness extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View view = inflater.inflate(postpc.project.erez0_000.weddingapp.R.layout.calendar_fragment, container, false);
        isWinter = false;
        // START find id of objects in the layout
        curDate = view.findViewById(postpc.project.erez0_000.weddingapp.R.id.show_date);

        setDateBtn = view.findViewById(postpc.project.erez0_000.weddingapp.R.id.set_date_btn);
        ...
        t.replace(postpc.project.erez0_000.weddingapp.R.id.calendarView, caldroidFragment);
        t.commit();
