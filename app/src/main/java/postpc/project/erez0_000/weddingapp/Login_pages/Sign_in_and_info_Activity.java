...
public class Sign_in_and_info_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(postpc.project.erez0_000.weddingapp.R.layout.activity_sign_in_and_info);
        ...
        backtomainButton = findViewById(postpc.project.erez0_000.weddingapp.R.id.gobacktomain);
        backtomainButton.setOnClickListener(this);

        savechangesButton = findViewById(postpc.project.erez0_000.weddingapp.R.id.gotosignin);
        savechangesButton.setOnClickListener(this);
        // END VIEW ON BUTTONS


        // START VIEW EDIT TEXTS
        edit_age = findViewById(postpc.project.erez0_000.weddingapp.R.id.editTextAge);
//        edit_age.addTextChangedListener(this);

        edit_number = findViewById(postpc.project.erez0_000.weddingapp.R.id.editTextNumber);
//        edit_number.addTextChangedListener(this);

        edit_cost = findViewById(postpc.project.erez0_000.weddingapp.R.id.editTextCost);
//        edit_cost.addTextChangedListener(this);
        // END VIEW EDIT TEXTS

        // START VIEW Spinners
        edit_season = findViewById(postpc.project.erez0_000.weddingapp.R.id.season_spinner);
//        edit_season.setOnItemSelectedListener(this);
        edit_area = findViewById(postpc.project.erez0_000.weddingapp.R.id.area_spinner);
//        edit_area.setOnItemSelectedListener(this);
        edit_type = findViewById(postpc.project.erez0_000.weddingapp.R.id.type_spinner);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case postpc.project.erez0_000.weddingapp.R.id.gotosignin:
                savechanges();
                break;
            case postpc.project.erez0_000.weddingapp.R.id.gobacktomain:
