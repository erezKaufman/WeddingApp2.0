...
import postpc.project.erez0_000.weddingapp.Login_pages.HorizontalRecyclerBusinesses.BusinessMinimalactivity;
...
public class BusinessChartFragment extends DialogFragment
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(postpc.project.erez0_000.weddingapp.R.layout.business_chart_fragment, container, false);
        recyclerView = view.findViewById(postpc.project.erez0_000.weddingapp.R.id.business_chart);
