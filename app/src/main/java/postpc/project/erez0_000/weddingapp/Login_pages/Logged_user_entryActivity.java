...
import postpc.project.erez0_000.weddingapp.Personal_window_Activity;
...
public class Logged_user_entryActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(postpc.project.erez0_000.weddingapp.R.layout.activity_logged_user_entry);
        Log.d(TAG, "onCreate: started Logged_user_entryActivity");

        gotopZone = findViewById(postpc.project.erez0_000.weddingapp.R.id.gotoPersonalZone);
        gotopZone.setOnClickListener(this);
        gotoSearch = findViewById(postpc.project.erez0_000.weddingapp.R.id.gotoSearch);
        gotoSearch.setOnClickListener(this);
        goto_categories = findViewById(postpc.project.erez0_000.weddingapp.R.id.goto_categories);
        goto_categories.setOnClickListener(this);

        horizontalBusLayout = findViewById(postpc.project.erez0_000.weddingapp.R.id.horizontalBusLayout);
        findViewById(postpc.project.erez0_000.weddingapp.R.id.chartLinearLayout).setOnClickListener(this);
        welcome_text = findViewById(postpc.project.erez0_000.weddingapp.R.id.welcome_text);
        welcome_text.setText(String.format("שלום %s! ברוך שובך", User.thisUser.getUsername()));

        // TODO add image of app's logo
        ImageView weddingImage = (ImageView) findViewById(postpc.project.erez0_000.weddingapp.R.id.weedingHello);
        ...
        recyclerView = findViewById(postpc.project.erez0_000.weddingapp.R.id.suggestion_list);
        curBalance = findViewById(postpc.project.erez0_000.weddingapp.R.id.balance);
        currentBalanceLayout = findViewById(postpc.project.erez0_000.weddingapp.R.id.chartLinearLayout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case postpc.project.erez0_000.weddingapp.R.id.gotoPersonalZone:
                startActivity(new Intent(this, Personal_window_Activity.class));
                break;
            case postpc.project.erez0_000.weddingapp.R.id.gotoSearch:
                openSearchActivity();
                break;
            case postpc.project.erez0_000.weddingapp.R.id.goto_categories:
                startCategoryActivity();
                break;
            case postpc.project.erez0_000.weddingapp.R.id.chartLinearLayout:
    ...
    public Map<String, String> getRandomPreferencesMap() {
        ...
        String businessType = getResources().getStringArray(postpc.project.erez0_000.weddingapp.R.array.Business_Type)[randomNum];
